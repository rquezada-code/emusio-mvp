...
@app.get("/")
def root():
    # ✅ Mantener landing en /practice-coach-ui
...
# (Opcional) Mock app screen si lo sigues usando
...
# Fake Emusio Lesson API (sirve para demo)
...
def practice_coach(request: PracticeRequest):
    ...
    # 1️⃣ Resolve lesson (SIN LLAMAR localhost)
...
"""
    ...
    practice_plan = (response.choices[0].message.content or "").strip()
